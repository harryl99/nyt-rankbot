...
def show_scoreboard(update: Update, context: CallbackContext):
    """
...
def clear_scoreboard(update: Update, context: CallbackContext):
    """
    Clear the database table for today's date and send a confirmation message.
